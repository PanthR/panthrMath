...
describe('Uniform Distribution', function() {
   ...
   */
   ...
   /* Rcode generating the tests:
      ...
      g$x1 = qunif(g$p, g$min, g$max, lower.tail=TRUE, log.p=TRUE)
      g$x2 = qunif(g$p, g$min, g$max, lower.tail=FALSE, log.p=TRUE)
   ...
   */
   ...
   [Infinity, -Infinity, -1, NaN, NaN],
   [NaN, -1.3, -1, NaN, NaN],
   [-Infinity, -1.3, -1, -1.3, -1],
   [-1, -1.3, -1, -1.18963616764857, -1.11036383235143],
   [0, -1.3, -1, -1, -1.3],
   [0.3, -1.3, -1, NaN, NaN],
   [1, -1.3, -1, NaN, NaN],
   ...
   [Infinity, -Infinity, 1.5, NaN, NaN],
   [NaN, -1.3, 1.5, NaN, NaN],
   [-Infinity, -1.3, 1.5, -1.3, 1.5],
   [-1, -1.3, 1.5, -0.269937564719961, 0.469937564719961],
   [0, -1.3, 1.5, 1.5, -1.3],
   [0.3, -1.3, 1.5, NaN, NaN],
   [1, -1.3, 1.5, NaN, NaN],
   [Infinity, -1.3, 1.5, NaN, NaN],
   [NaN, 1.5, 1.5, NaN, NaN],
   [-Infinity, 1.5, 1.5, 1.5, 1.5],
   [-1, 1.5, 1.5, 1.5, 1.5],
   [0, 1.5, 1.5, 1.5, 1.5],
   [0.3, 1.5, 1.5, NaN, NaN],
   [1, 1.5, 1.5, NaN, NaN],
   ...
   [Infinity, -Infinity, 3.7, NaN, NaN],
   [NaN, -1.3, 3.7, NaN, NaN],
   [-Infinity, -1.3, 3.7, -1.3, 3.7],
   [-1, -1.3, 3.7, 0.539397205857212, 1.86060279414279],
   [0, -1.3, 3.7, 3.7, -1.3],
   [0.3, -1.3, 3.7, NaN, NaN],
   [1, -1.3, 3.7, NaN, NaN],
   [Infinity, -1.3, 3.7, NaN, NaN],
   [NaN, 1.5, 3.7, NaN, NaN],
   [-Infinity, 1.5, 3.7, 1.5, 3.7],
   [-1, 1.5, 3.7, 2.30933477057717, 2.89066522942283],
   [0, 1.5, 3.7, 3.7, 1.5],
   [0.3, 1.5, 3.7, NaN, NaN],
   [1, 1.5, 3.7, NaN, NaN],
   ...
   [Infinity, Infinity, Infinity, NaN, NaN]
         ...
         x1r = tuple[3];
         x2r = tuple[4];
         x1 = main.qunif(min, max, true, true)(p);
         x2 = main.qunif(min, max, false, true)(p);
